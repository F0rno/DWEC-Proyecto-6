    ...
    methods: {
        ...
        toogleDarkMode() {
            ...
            Change this vars
                ...
                --black: #000000;
            */
            // document.documentElement.style.setProperty('--light-green', '');
